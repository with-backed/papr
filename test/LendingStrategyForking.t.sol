...
//         emit VaultCreated(
//             strategy.vaultKey(request.collateral), borrower, 1, 1e18
//             );
...
//         uint256 mark = 1e18;
//         uint256 rFunding =
//             FixedPointMathLib.divWadDown(block.timestamp - start, PERIOD);
//         uint256 indexMarkRatio = FixedPointMathLib.divWadDown(index, mark);
//         int256 multiplier =
//             FixedPointMathLib.powWad(int256(indexMarkRatio), int256(rFunding));
//         if (multiplier > 5 * 1e18) {
//             multiplier = 5 * 1e18;
//         }
//         uint256 targetGrowth = FixedPointMathLib.mulWadDown(
//             targetGrowthPerPeriod, rFunding
//         ) + FixedPointMathLib.WAD;
//         emit log_named_uint("rFunding", rFunding);
//         emit log_string(
//             string.concat(
//                 "target annual growth ", UintStrings.decimalString(annualAPR, 16, true)
//             )
//             );
...
//         emit log_named_int(
//             "new norm",
//             multiplier * int256(targetGrowth) / int256(FixedPointMathLib.WAD)
//             );
//     }
