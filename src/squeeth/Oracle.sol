...
contract Oracle is IOracle {
    ...
    function getHistoricalTwap(
        ...
        returns (uint256)
    {
        return _fetchHistoricTwap(
            _pool, _base, _quote, _secondsAgoToStartOfTwap, _secondsAgoToEndOfTwap
        );
    }
        ...
        returns (uint256)
    {
        int24 twapTick = OracleLibrary.consultAtHistoricTime(
            _pool, _secondsAgoToStartOfTwap, _secondsAgoToEndOfTwap
        );
